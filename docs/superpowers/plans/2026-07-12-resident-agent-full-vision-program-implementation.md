...
| 131 | U: packages/ui/src/agent/resident-runtime-types.ts; packages/ui/src/agent/resident-runtime-adapter.ts; packages/ui/test/resident-runtime-adapter.test.ts | CF-1; deferred until 137 and 140 expose the authoritative local-runtime wake-status projection/route | npm test -- packages/ui/test/resident-runtime-adapter.test.ts packages/ui/test/agent-adapter.test.ts | Parse the exact authoritative production DTO; reject stale, absent, forged, and cross-run values without inventing browser-owned attempt or lease facts. |
...
Merge 120 before consumers; 121–123 before 134/135/138; 124/125 before 137; 126–130 before 133/136/139; 132–139 before 140; rebase and restart deferred Task 131 after the 137/140 authoritative status producer/route merges; then merge routes before 141. A coordinator records the rebase SHA and runs the table command after every dependency merge.
