...
- Full verification: `npm run verify`
  - Passed: `typecheck passed`, 148 test files passed with 1 skipped, 1406 tests passed with 1 skipped, `tests passed`, Vite production build succeeded, `factory-readiness passed`.
