...
## RV-1-E-299 — Authenticated lineage reviewer identities

- Lifecycle/executability reviewer
  `019f65b0-fed3-7f00-9f15-fecb992da288` and authority/import/bypass reviewer
  `019f65b1-482d-7cb1-8c57-c23d1459a334` are active read-only on the exact
  candidate, lineage, and canonical checkpoint in RV-1-E-298. Both use
  `gpt-5.6-terra` at `xhigh` in fresh isolated worktrees and are pinned under
  distinct CF-1R20 review titles.
- Neither may edit, run full/live/provider/credential gates, touch `neo`, or
  carry forward any earlier verdict. Source dispatch and plan integration
  remain closed until both return explicit unqualified **APPROVED** verdicts
  and those verdicts are durably recorded.
...
## RV-1-E-305 — Physical-checkout reviewer identities

- Lifecycle/executability reviewer
  `019f65de-badd-74f3-9d20-a6406c091aa9` and authority/import/bypass reviewer
  `019f65de-b9c4-7243-a300-e5ce79e2e074` are active read-only on the exact
  candidate, lineage, and canonical checkpoint in RV-1-E-304. Both use
  `gpt-5.6-terra` at `xhigh` in fresh isolated worktrees and are pinned under
  distinct CF-1R22 review titles.
- Neither may edit, run full/live/provider/credential gates, touch `neo`, or
  carry forward any earlier verdict. Source dispatch and plan integration
  remain closed until both return explicit unqualified **APPROVED** verdicts
  and those verdicts are durably recorded.
...
## RV-1-E-308 — Post-command reviewer identities

- Lifecycle/executability reviewer
  `019f65f0-2703-77d1-b23e-a3f164c903e7` and authority/import/bypass reviewer
  `019f65f0-2649-77e2-a24c-5683e8245de0` are active read-only on the exact
  candidate, lineage, and canonical checkpoint in RV-1-E-307. Both use
  `gpt-5.6-terra` at `xhigh` in fresh isolated worktrees and are pinned under
  distinct CF-1R23 review titles.
- Neither may edit, run full/live/provider/credential gates, touch `neo`, or
  carry forward any earlier verdict. Source dispatch and plan integration
  remain closed until both return explicit unqualified **APPROVED** verdicts
  and those verdicts are durably recorded.
...
## RV-1-E-311 — Exact-checkout reviewer identities

- Lifecycle/executability reviewer
  `019f6604-eeae-7c43-94fc-f2403790fa49` and authority/import/bypass reviewer
  `019f6604-efbe-72f0-b8ef-aae20c51773f` are active read-only on the exact
  candidate, lineage, and canonical checkpoint in RV-1-E-310. Both use
  `gpt-5.6-terra` at `xhigh` in fresh isolated worktrees and are pinned under
  distinct CF-1R24 review titles.
- Neither may edit, run full/live/provider/credential gates, touch `neo`, or
  carry forward any earlier verdict. Source dispatch and plan integration
  remain closed until both return explicit unqualified **APPROVED** verdicts
  and those verdicts are durably recorded.
...
## RV-1-E-317 — Same-payload reviewer identities

- Lifecycle/executability reviewer
  `019f6638-81de-7c02-8e91-bfe7cf36a164` and authority/import/bypass reviewer
  `019f6638-c5de-7a83-8292-fc40a222d33e` are active read-only on the exact
  CF-1R26 candidate, lineage, and canonical checkpoint in RV-1-E-316. Both use
  `gpt-5.6-terra` at `xhigh` in fresh isolated worktrees and are pinned under
  distinct review titles.
- Both were explicitly given the approved external-sibling-C and mutable-
  evidence-suffix boundaries plus the external program-registry location.
  Neither may edit, run full/live/provider/credential gates, touch `neo`, or
...
## RV-1-E-391 — Task135D named-default reviews dispatched

- Fresh Terra/xhigh private-authority/lifecycle reviewer
  `019f66f0-1cf6-7123-92f7-6ae002ff78d7` audits factory identity,
  snapshots, hostile mutation, currentness, close behavior, non-leakage,
  production invariants, and exact scope.
- Fresh Terra/xhigh AST import-authority reviewer
  `019f66f0-1dc3-7110-9d4f-1ea42f0ed9a8` audits all decoded static,
  default, named-default, type, re-export, dynamic, and CommonJS forms,
  exact root-bound source identity, lookalike rejection, allowlist, public
