...
| W3-149 | `packages/agent/src/prr-proactive-trigger.ts`, `packages/agent/test/prr-proactive-trigger.test.ts` | T | CF1-T-REQUEST, CF1-T-EVALUATOR, CF1-T-HIGH-WATER | exact PRR source events and admission scope | none; demand only | trigger fingerprint/dedupe/gate key | `npm test -- packages/agent/test/prr-proactive-trigger.test.ts packages/agent/test/proactive-triggers.test.ts` | Task118 reviewed merged/rebased SHA and140 readiness SHA plus `CF1-INTEGRATION-SHA` | rerun command proving no send |
| W3-150 | `packages/agent/src/ingestion-proactive-trigger.ts`, `packages/agent/test/ingestion-proactive-trigger.test.ts` | T | CF1-T-REQUEST, CF1-T-EVALUATOR, CF1-T-HIGH-WATER | ingestion/evidence/readiness source event binding | none; demand only | trigger fingerprint/dedupe/gate key | `npm test -- packages/agent/test/ingestion-proactive-trigger.test.ts packages/agent/test/proactive-triggers.test.ts` | Task118 reviewed merged/rebased SHA and140 readiness SHA plus `CF1-INTEGRATION-SHA` | rerun command proving no parse/provider/graph effect |
| W3-151 | `packages/agent/src/investigation-proactive-trigger.ts`, `packages/agent/test/investigation-proactive-trigger.test.ts` | T | CF1-T-REQUEST, CF1-T-EVALUATOR, CF1-T-HIGH-WATER | cadence/high-water/source projection binding | none; demand only | trigger fingerprint/dedupe/gate key | `npm test -- packages/agent/test/investigation-proactive-trigger.test.ts packages/agent/test/proactive-triggers.test.ts` | Task118 reviewed merged/rebased SHA and140 readiness SHA plus `CF1-INTEGRATION-SHA` | rerun command proving cooldown/budget/high-water |
...
const requiredIds = new Set([
  "CF1-L-PLAN", "CF1-L-OBS", "CF1-L-STEP", "CF1-L-RESULT", "CF1-L-POLICY", "CF1-T-REQUEST", "CF1-T-EVALUATOR", "CF1-T-HIGH-WATER", "CF1-W-AUTHORITY", "CF1-W-LIFECYCLE", "CF1-W-SUPERVISOR", "CF1-H-HANDOFF", "CF1-H-MOUNTED-STORE", "CF1-P-POSTURE", "CF1-P-OS-SECRET", "CF1-P-INVOKE", "CF1-P-SCHEMAS", "CF1-P-TRANSFER", "CF1-R-CONTEXT", "CF1-R-PROMPT", "CF1-R-RUNNERS", "CF1-R-STORES", "CF1-R-FACTORY", "CF1-R-READINESS", "CF1-P-CONFIG", "CF1-U-BROWSER", "CF1-U-RUNTIME-DTO", "CF1-U-WAKE-DTO", "CF1-U-HANDOFF-DTO", "CF1-U-COMMAND", "CF1-A-EVIDENCE",
...
const canonical = new Map([
  ["CF1-L-PLAN", ["agent.resident-plan.recorded.v1", "ResidentPlanRecord.v1", "plan-observation-contracts.ts` / L", "120,136,R,U,A", "task/attempt/run", "none; later gateway", "task+attempt+run+plan-revision+policy-hash", "plan-observation-contracts.test.ts", "120 merges before 132,133,136,140"]],
  ["CF1-L-OBS", ["agent.resident-observation.recorded.v1", "ResidentObservationRecord.v1", "plan-observation-contracts.ts` / L", "120,136,H,A", "planRecordEventId", "none", "plan-record-event+observation-ordinal+category", "plan-observation-projection.test.ts", "120 before 136"]],
  ["CF1-L-STEP", ["agent.resident-tool-step.recorded.v1", "ResidentToolStepRecord.v1", "plan-observation-contracts.ts` / L", "136,H,P,A", "gateway request/event IDs", "existing exact gateway class only", "tool-version+preview-hash", "execution-loop.test.ts", "gateway compatibility before 136"]],
  ["CF1-L-RESULT", ["agent.resident-loop.suspended.v1", "ResidentLoopTerminalOrResumableResult.v1", "bounded-agent-loop.ts` / L", "136,H,W,U,A", "final observation", "no self-approval", "final-observation-event+outcome-category", "bounded-agent-loop.test.ts", "136 consumes 120,124,126-130"]],
  ["CF1-L-POLICY", ["immutable resident plan policy", "ResidentPlanPolicy.v1", "plan-observation-contracts.ts` / L", "118,120,136,149,150,151,R,W,U,A", "policy version/hash", "policy never self-approves", "policy-version+policy-hash", "bounded-agent-loop.test.ts", "120 policy merge before 118,136,149-151"]],
  ["CF1-T-REQUEST", ["agent.trigger.requested.v1", "ResidentTriggerDescriptor.v1", "proactive-triggers.ts` / T", "149,150,151,L,W,H,A", "sorted source events", "a request is never approval", "request-fingerprint", "proactive-triggers.test.ts", "149-151 rebase T merge"]],
  ["CF1-T-EVALUATOR", ["agent.trigger.requested.v1", "TriggerEvaluationInput.v1", "proactive-triggers.ts` / T", "118,149,150,151,U,A", "conditional append rereads scope", "trigger request is demand only", "snapshot-revision", "agent-trigger-contracts.test.ts", "149-151 require Task118 reviewed merged SHA"]],
  ["CF1-T-HIGH-WATER", ["canonical trigger request", "TriggerHighWaterMark.v1", "trigger-projection.ts` / T", "118,149,150,151,U,A", "replayed mounted event stream", "projection cannot create a request", "source-high-water", "trigger-projection.test.ts", "never an undefined `T merge`"]],
  ["CF1-W-AUTHORITY", ["no synthetic outage event", "WorkspaceAvailabilityAuthority.v1", "portable-workspace-lifecycle.ts` / W", "125,132,135,137,R,H,L,T,U,A", "ledger high-water", "none", "authority evidence hash+operation+mount instance", "portable-workspace-lifecycle.test.ts", "125 before 132,135,137"]],
  ["CF1-W-LIFECYCLE", ["agent.wake.supervisor.lease.claimed.v1", "WakeStatusDto.v1", "wake-supervisor.ts` / W", "124,137,141,U,R,A", "epoch, policy, identity", "local supervision command only", "workspace+epoch+transition+causation", "wake-supervisor.test.ts", "124 before 134,137,141"]],
  ["CF1-W-SUPERVISOR", ["frozen wake lifecycle", "WakeSupervisor.v1", "wake-supervisor.ts` / W", "124,137,141,U,A", "one immutable admission snapshot", "no provider/tool/effect authority", "transition+causation+lease", "scheduler.test.ts", "124 reviewed merged SHA before 137 and141"]],
  ["CF1-H-HANDOFF", ["agent.specialist-handoff.recorded", "HandoffReadback.v1", "H owns manifest/projection semantics", "121,122,123,135,138,U,L,A", "material readback -> final-output", "no completion approval", "material/manifest hashes", "specialist-handoff-projection.test.ts", "121-123 before 134,135,138"]],
  ["CF1-H-MOUNTED-STORE", ["mounted handoff bytes", "MountedHandoffStore.v1", "mounted-agent-artifact-stores.ts` / R", "121,122,123,135,138,U,A", "mount generation", "store never establishes completion", "authority-hash+artifact-hash", "agent-handoff-projection.test.ts", "135 owns mounted store after 121-123 and125"]],
  ["CF1-P-POSTURE", ["agent.provider.feasibility.observed.v1", "ProviderCapability.v2", "P provider files / P", "126-130,133,136,139,R,U,A", "provider/model/capability/ref", "no secret resolution without exact use", "capability-hash+provider+model", "provider-readiness.test.ts", "126-130 before 133,136,139"]],
  ["CF1-P-OS-SECRET", ["no new durable secret event", "OsSecretStore.v1", "os-secret-store.ts` / P", "127,126,128,129,130,133,139,U,A", "exact-use credential ref", "secret resolution never authorizes invocation", "workspace+mount+run+purpose", "os-secret-store.test.ts", "127 reviewed merged SHA"]],
  ["CF1-P-INVOKE", ["invocation consumes existing transfer approval", "ProviderInvocationPreparation.v1", "agent-provider-configuration.ts` / P", "126-130,133,136,139,R,U,A", "prompt hash/policy/readiness", "provider-byte-transfer", "preview-hash", "agent-provider-configuration.test.ts", "139 after 126-130 and133"]],
  ["CF1-P-SCHEMAS", ["canonical and superseding records", "canonical error categories", "P provider files / P", "126-130,133,139,U,A", "fixture provenance", "migration never grants byte transfer", "fixture-hash+error-category", "secret-store.test.ts", "P schema compatibility record"]],
  ["CF1-P-TRANSFER", ["provider-byte-transfer", "VerifiedProviderPosture.v1", "existing approval gateway", "P,R,L,H,A", "independent human, preview hash", "`provider-byte-transfer`", "preview-hash+run+provider", "prompt-artifacts.test.ts", "no lane redefines gateway"]],
  ["CF1-R-CONTEXT", ["verified context remains provenance-bound", "MountedContextCapability.v1", "agent-runtime-context-packs.ts` / R", "132,133,134,136,140,H,A", "descriptor/version/hash", "none", "pack-id+version+descriptor-hash", "agent-runtime-context-packs.test.ts", "132 after 120 and125"]],
  ["CF1-R-PROMPT", ["prompt artifact remains the provider boundary", "ProductionPromptCapability.v1", "agent-runtime-prompt-renderer.ts` / R", "133,P,L,H,A", "renderer/template hashes", "when remote", "template-version+renderer-hash", "agent-runtime-prompt-renderer.test.ts", "133 after 120 and126-130"]],
  ["CF1-R-RUNNERS", ["runner dispatch reads frozen lifecycle", "ProductionSpecialistRunnerCapability.v1", "agent-runtime-specialist-runners.ts` / R", "134,140,H,L,A", "handoff schema", "existing workflow/gateway classes", "runner-version+descriptor-hash", "agent-runtime-specialist-runners.test.ts", "134 after 121-124"]],
  ["CF1-R-STORES", ["mounted receipts require exact readback", "MountedAgentArtifactStores.v1", "mounted-agent-artifact-stores.ts` / R", "135,138,140,H,A", "manifest hash before recorded", "none", "manifest-hash+material-hash", "mounted-agent-artifact-stores.test.ts", "135 after 121-123 and125"]],
  ["CF1-R-FACTORY", ["one composition boundary", "ProductionAgentRuntimeCompositionInput.v1", "agent-runtime-factory.ts` / R only", "140,U,A", "one verified mounted authority", "consumes current classes", "component binding hashes", "agent-runtime-composition.test.ts", "140 after 132-139"]],
  ["CF1-R-READINESS", ["readiness is a safe immutable snapshot", "ProductionRuntimeReadinessCapability.v1", "agent-runtime-factory.ts` / R only", "137,140,U,A", "structural and invocation posture", "readiness does not invoke or approve", "component-hashes", "wake-supervisor-runtime.test.ts", "R 140 merge before U route"]],
  ["CF1-P-CONFIG", ["P feasibility evidence", "ProviderCapabilityRegistry.v1", "agent-provider-configuration.ts` / P only", "139,140,U,A", "exact prompt policy binding", "existing provider-byte-transfer only", "registry-version+capability-hash", "provider-registry.test.ts", "139 after 126-130 and133"]],
  ["CF1-U-BROWSER", ["routes project only frozen readback", "ResidentRuntimeDto.v1", "resident-runtime-adapter.ts` / U", "131,141,A", "route producer and readback IDs", "browser never approves or effects", "dto-schema-version+run-id", "resident-runtime-adapter.test.ts", "131 before 141"]],
  ["CF1-U-RUNTIME-DTO", ["parsed server projection only", "ResidentRuntimeStatusDto.v1", "resident-runtime-types.ts` / U", "131,141,A", "snapshot ID", "unavailable/stale/forged values fail closed", "snapshot-id+workspace+task", "agent-adapter.test.ts", "131 reviewed merge before 141"]],
  ["CF1-U-WAKE-DTO", ["wake view is a parsed lifecycle readback", "ResidentWakeDto.v1", "resident-runtime-types.ts` / U", "131,141,A", "pause/recovery readback", "local supervision command only", "epoch+lease+high-water", "agent-supervision-routes.test.ts", "131 and137 reviewed merges before 141"]],
  ["CF1-U-HANDOFF-DTO", ["handoff is a durable readback projection", "ResidentHandoffDto.v1", "resident-runtime-types.ts` / U", "131,138,141,A", "material/manifest receipts/hashes", "terminal-looking status is not completion", "recorded-event+manifest-hash", "agent-handoff-projection.test.ts", "138 reviewed merge before U consumer"]],
  ["CF1-U-COMMAND", ["route accepts only six versioned request forms", "SupportedResidentRuntimeCommandDto.v1", "agent-supervision-routes.ts` / U; `packages/local-runtime/test/agent-supervision-routes.test.ts` / Task141", "141,U,A", "current server snapshot", "no provider/tool/send/approval/export/graph effect", "expected-snapshot-id+idempotency-key", "resident-supervision-panel.test.tsx", "Task141 requires reviewed 131 and137-140 merges"]],
  ["CF1-A-EVIDENCE", ["acceptance evidence is safe report only", "ResidentAcceptanceEvidence.v1", "A-owned test fixtures", "A-01 through A-10, Coordinator", "safe IDs/hashes/counts/categories", "coordinator-only live Nous", "producer-SHA+command-identity", "resident-acceptance-adversarial.test.ts", "A never patches production"]],
]);
const ownershipCanonical = new Map([
  ["W2-141", ["agent-supervision-routes.test.ts", "U", "CF1-U-COMMAND", "strict runtime route DTO", "supported local command policy only", "dto+request-id+command", "resident-supervision-panel.test.tsx", "131,137-140 SHAs plus `CF1-INTEGRATION-SHA`", "routes and factory merge"]],
  ["W3-149", ["prr-proactive-trigger.ts", "T", "CF1-T-REQUEST, CF1-T-EVALUATOR, CF1-T-HIGH-WATER", "exact PRR source events", "none; demand only", "trigger fingerprint/dedupe/gate key", "prr-proactive-trigger.test.ts", "Task118 reviewed merged/rebased SHA", "no send"]],
  ["W3-150", ["ingestion-proactive-trigger.ts", "T", "CF1-T-REQUEST, CF1-T-EVALUATOR, CF1-T-HIGH-WATER", "ingestion/evidence/readiness", "none; demand only", "trigger fingerprint/dedupe/gate key", "ingestion-proactive-trigger.test.ts", "Task118 reviewed merged/rebased SHA", "no parse/provider/graph effect"]],
  ["W3-151", ["investigation-proactive-trigger.ts", "T", "CF1-T-REQUEST, CF1-T-EVALUATOR, CF1-T-HIGH-WATER", "cadence/high-water", "none; demand only", "trigger fingerprint/dedupe/gate key", "investigation-proactive-trigger.test.ts", "Task118 reviewed merged/rebased SHA", "cooldown/budget/high-water"]],
]);
...
function validate(candidate, integrityHash = expectedHash) {
  ...
  if (actualHash !== integrityHash) errors.push("matrix integrity hash mismatch");
  ...
  const rowMap = new Map(candidateRows.map((row) => [rowCells(row)[0], rowCells(row)]));
  for (const [id, expectedCells] of canonical) {
    const cells = rowMap.get(id);
    if (!cells) continue;
    expectedCells.forEach((expected, index) => {
      if (!cells[index + 1]?.includes(expected)) errors.push(`${id}: canonical semantic mismatch in field ${index + 1}`);
    });
  }
  for (const [id, expectedCells] of ownershipCanonical) {
    const cells = rowMap.get(id);
    if (!cells) continue;
    expectedCells.forEach((expected, index) => {
      if (!cells[index + 1]?.includes(expected)) errors.push(`${id}: canonical ownership/rebase mismatch in field ${index + 1}`);
    });
  }
...
const matrixHash = (candidate) => {
  const candidateStart = candidate.indexOf(matrixStart);
  const candidateEnd = candidate.indexOf(matrixEnd);
  return createHash("sha256").update(candidate.slice(candidateStart, candidateEnd + matrixEnd.length)).digest("hex");
};
const semanticBypass = text.replace("ResidentPlanRecord.v1", "CounterfactualPlanRecord.v9");
if (!validate(semanticBypass, matrixHash(semanticBypass)).some((error) => error.includes("CF1-L-PLAN: canonical semantic mismatch"))) {
  throw new Error("audit accepted CounterfactualPlanRecord.v9 after recomputed integrity hash");
}
let mutations = 1;
...
for (const [id, expectedCells] of canonical) {
  const row = rows.find((candidateRow) => rowCells(candidateRow)[0] === id);
  if (!row) throw new Error(`missing canonical row before counterfactual audit: ${id}`);
  for (const expected of expectedCells) {
    const candidate = text.replace(row, row.replace(expected, `Counterfactual-${id}`));
    if (!validate(candidate, matrixHash(candidate)).some((error) => error.includes(`${id}: canonical semantic mismatch`))) {
      throw new Error(`audit escaped recomputed-hash semantic mutation of ${id}: ${expected}`);
    }
    mutations += 1;
  }
}
for (const id of ["CF1-L-POLICY", "CF1-T-EVALUATOR", "CF1-T-HIGH-WATER", "CF1-W-SUPERVISOR", "CF1-H-MOUNTED-STORE", "CF1-P-OS-SECRET", "CF1-P-INVOKE", "CF1-P-SCHEMAS", "CF1-R-READINESS", "CF1-U-RUNTIME-DTO", "CF1-U-WAKE-DTO", "CF1-U-HANDOFF-DTO", "CF1-U-COMMAND"]) {
  const row = rows.find((candidateRow) => rowCells(candidateRow)[0] === id);
  const candidate = text.replace(`${row}\n`, "");
  if (!validate(candidate, matrixHash(candidate)).some((error) => error.includes(`${id}: missing or conflicting row`))) throw new Error(`audit escaped missing required interface row ${id}`);
  mutations += 1;
}
...
const routeOwnerConflict = text.replace(" / Task141 |", " / Task141 + R |");
if (!validate(routeOwnerConflict).some((error) => error.includes("non-dispatchable owner"))) throw new Error("audit escaped Task141 route-test owner conflict");
const vagueTriggerRebase = text.replaceAll("Task118 reviewed merged/rebased SHA", "T merge");
if (!validate(vagueTriggerRebase, matrixHash(vagueTriggerRebase)).some((error) => error.includes("canonical ownership/rebase mismatch"))) throw new Error("audit accepted undefined T merge");
for (const [expected, counterfactual] of [
  ["Queue retry", "Run retry"],
  ["Request cancellation", "Cancelled"],
  ["Resume eligible wake processing", "Start the agent"]
]) {
  const candidate = text.replace(expected, counterfactual);
  if (!validate(candidate, matrixHash(candidate)).some((error) => error.includes("frozen cockpit command mismatch"))) throw new Error(`audit accepted cockpit counterfactual ${counterfactual}`);
  mutations += 1;
}
console.log(`GREEN: CF-1 semantic contract audit passed (${mutations + 5} direct counterfactual mutations rejected, including recomputed-hash semantic, required-interface, owner, trigger-rebase, and cockpit-label failures).`);
NODE
```
