  ...
  return (
    <aside aria-label="Request detail rail" className="h-full p-4 lg:p-5">
      {selectedRequest === undefined ? (
        ...
        <SelectedRequestDetail selectedRequest={selectedRequest} />
      )}
    </aside>
  );
}

function SelectedRequestDetail({ selectedRequest }: { readonly selectedRequest: PrrDetailModel }) {
  ...
  return (
    <div>
      ...
      <section className="mt-5 border border-[var(--console-line)] bg-[var(--console-panel)]/56 p-3">
